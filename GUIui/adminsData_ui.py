# Form implementation generated from reading ui file 'c:\Qt\bioFinal\GUIui\adminsData.ui'
#
...
class Ui_adminsDataWindow(object):
    def setupUi(self, adminsDataWindow):
        ...
        adminsDataWindow.setStatusBar(self.statusbar)

        self.retranslateUi(adminsDataWindow)
        QtCore.QMetaObject.connectSlotsByName(adminsDataWindow)

    def retranslateUi(self, adminsDataWindow):
